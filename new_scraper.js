            ...
            for (i = 0 ; i < length ; i++){
                ...
                if (title_checker.includes(data.Titles[i])){
                    ...
                    $("#info").append(
                        ...
                        "<div class='col py-2'><div class='card m-4 p-2 h-100' style='width: 18rem'><img src=https://logo.clearbit.com/"+site.hostname+" class='card-img-top' onerror=this.src='./current-events-512.png'><div class='card-body d-flex flex-column'><p class='card-text'>" + 
